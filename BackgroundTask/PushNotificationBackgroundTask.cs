...
// Type: BackgroundTask.PushNotificationBackgroundTask
...
namespace BackgroundTask
{
  ...
  public sealed class PushNotificationBackgroundTask : IBackgroundTask, IStringable
  {
    [MethodImpl(MethodCodeType = MethodCodeType.Runtime)]
    public extern PushNotificationBackgroundTask();
