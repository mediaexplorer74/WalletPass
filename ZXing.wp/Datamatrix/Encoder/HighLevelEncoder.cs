...
namespace ZXing.Datamatrix.Encoder
{
  ...
  internal static class HighLevelEncoder
  {
    ...
    public static string encodeHighLevel(string msg) => HighLevelEncoder.encodeHighLevel(msg, SymbolShapeHint.FORCE_NONE, (Dimension) null, (Dimension) null, 0);
    ...
    internal static void illegalCharacter(char c) => throw new ArgumentException(string.Format("Illegal character: {0} (0x{1:X})", (object) c, (object) (int) c));
  }
}
