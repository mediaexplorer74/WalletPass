...
namespace ZXing.Datamatrix.Encoder
{
  ...
  public class SymbolInfo
  {
    ...
    public static SymbolInfo lookup(int dataCodewords) => SymbolInfo.lookup(dataCodewords, SymbolShapeHint.FORCE_NONE, true);
    ...
    private static SymbolInfo lookup(int dataCodewords, SymbolShapeHint shape, bool fail) => SymbolInfo.lookup(dataCodewords, shape, (Dimension) null, (Dimension) null, fail);
