...
namespace ZXing.Datamatrix
{
  ...
  public class DatamatrixEncodingOptions : EncodingOptions
  {
    ...
    {
      get => this.Hints.ContainsKey(EncodeHintType.DATA_MATRIX_SHAPE) ? new SymbolShapeHint?((SymbolShapeHint) this.Hints[EncodeHintType.DATA_MATRIX_SHAPE]) : new SymbolShapeHint?();
      set
      {
        if (!value.HasValue)
        {
    ...
    {
      get => this.Hints.ContainsKey(EncodeHintType.MIN_SIZE) ? (Dimension) this.Hints[EncodeHintType.MIN_SIZE] : (Dimension) null;
      set
      {
        if (value == null)
        {
    ...
    {
      get => this.Hints.ContainsKey(EncodeHintType.MAX_SIZE) ? (Dimension) this.Hints[EncodeHintType.MAX_SIZE] : (Dimension) null;
      set
      {
        if (value == null)
        {
    ...
    {
      get => this.Hints.ContainsKey(EncodeHintType.DATA_MATRIX_DEFAULT_ENCODATION) ? new int?((int) this.Hints[EncodeHintType.DATA_MATRIX_DEFAULT_ENCODATION]) : new int?();
      set
      {
        if (!value.HasValue)
        {
