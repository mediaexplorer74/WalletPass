...
namespace ZXing
{
  ...
  public sealed class InvertedLuminanceSource : LuminanceSource
  {
    ...
    public override LuminanceSource crop(int left, int top, int width, int height) => (LuminanceSource) new InvertedLuminanceSource(this.@delegate.crop(left, top, width, height));
    ...
    public override LuminanceSource rotateCounterClockwise() => (LuminanceSource) new InvertedLuminanceSource(this.@delegate.rotateCounterClockwise());
    ...
    /// </summary>
    /// <returns>A rotated version of this object.</returns>
    public override LuminanceSource rotateCounterClockwise45() => (LuminanceSource) new InvertedLuminanceSource(this.@delegate.rotateCounterClockwise45());
  }
}
