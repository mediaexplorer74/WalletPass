...
namespace BigIntegerLibrary
{
  ...
  internal sealed class Base10BigInteger
  {
    ...
    /// false otherwise</returns>
    public override bool Equals(object o) => (object) (o as Base10BigInteger) != null && this.Equals((Base10BigInteger) o);
    ...
    /// <param name="b">The 2nd Base10BigInteger</param>
    /// <returns>True if a &gt;= b, false otherwise</returns>
    public static bool GreaterOrEqual(Base10BigInteger a, Base10BigInteger b) => Base10BigInteger.Greater(a, b) || object.Equals((object) a, (object) b);

    /// <summary>Smaller test between two Base10BigIntegers.</summary>
    /// <param name="a">The 1st Base10BigInteger</param>
    /// <param name="b">The 2nd Base10BigInteger</param>
    /// <returns>True if a &lt; b, false otherwise</returns>
    public static bool Smaller(Base10BigInteger a, Base10BigInteger b) => !Base10BigInteger.GreaterOrEqual(a, b);

    /// <summary>Smaller or equal test between two Base10BigIntegers.</summary>
    /// <param name="a">The 1st Base10BigInteger</param>
    /// <param name="b">The 2nd Base10BigInteger</param>
    /// <returns>True if a &lt;= b, false otherwise</returns>
    public static bool SmallerOrEqual(Base10BigInteger a, Base10BigInteger b) => !Base10BigInteger.Greater(a, b);
    ...
    public static Base10BigInteger Abs(Base10BigInteger n) => new Base10BigInteger(n)
    {
      sign = Sign.Positive
    };
    ...
    /// <param name="b">The 2nd Base10BigInteger</param>
    /// <returns>True if a == b, false otherwise</returns>
    public static bool operator ==(Base10BigInteger a, Base10BigInteger b) => object.Equals((object) a, (object) b);
    ...
    /// <param name="b">The 2nd Base10BigInteger</param>
    /// <returns>True if a &gt; b, false otherwise</returns>
    public static bool operator >(Base10BigInteger a, Base10BigInteger b) => Base10BigInteger.Greater(a, b);

    /// <summary>Smaller test between two Base10BigIntegers.</summary>
    /// <param name="a">The 1st Base10BigInteger</param>
    /// <param name="b">The 2nd Base10BigInteger</param>
    /// <returns>True if a &lt; b, false otherwise</returns>
    public static bool operator <(Base10BigInteger a, Base10BigInteger b) => Base10BigInteger.Smaller(a, b);

    /// <summary>Greater or equal test between two Base10BigIntegers.</summary>
    /// <param name="a">The 1st Base10BigInteger</param>
    /// <param name="b">The 2nd Base10BigInteger</param>
    /// <returns>True if a &gt;= b, false otherwise</returns>
    public static bool operator >=(Base10BigInteger a, Base10BigInteger b) => Base10BigInteger.GreaterOrEqual(a, b);

    /// <summary>Smaller or equal test between two Base10BigIntegers.</summary>
    /// <param name="a">The 1st Base10BigInteger</param>
    /// <param name="b">The 2nd Base10BigInteger</param>
    /// <returns>True if a &lt;= b, false otherwise</returns>
    public static bool operator <=(Base10BigInteger a, Base10BigInteger b) => Base10BigInteger.SmallerOrEqual(a, b);
    ...
    /// <param name="b">The 2nd Base10BigInteger</param>
    /// <returns>The Base10BigInteger result of the addition</returns>
    public static Base10BigInteger operator +(Base10BigInteger a, Base10BigInteger b) => Base10BigInteger.Addition(a, b);

    /// <summary>Subtraction operation of two Base10BigIntegers.</summary>
    /// <param name="a">The 1st Base10BigInteger</param>
    /// <param name="b">The 2nd Base10BigInteger</param>
    /// <returns>The Base10BigInteger result of the subtraction</returns>
    public static Base10BigInteger operator -(Base10BigInteger a, Base10BigInteger b) => Base10BigInteger.Subtraction(a, b);

    /// <summary>Multiplication operation of two Base10BigIntegers.</summary>
    /// <param name="a">The 1st Base10BigInteger</param>
    /// <param name="b">The 2nd Base10BigInteger</param>
    /// <returns>The Base10BigInteger result of the multiplication</returns>
    public static Base10BigInteger operator *(Base10BigInteger a, Base10BigInteger b) => Base10BigInteger.Multiplication(a, b);
