...
namespace BigIntegerLibrary
{
  ...
  internal sealed class BigInteger : IEquatable<BigInteger>, IComparable, IComparable<BigInteger>
  {
    ...
    /// false otherwise</returns>
    public override bool Equals(object o) => (object) (o as BigInteger) != null && this.Equals((BigInteger) o);
    ...
    public int CompareTo(object obj) => (object) (obj as BigInteger) != null ? this.CompareTo((BigInteger) obj) : throw new ArgumentException("obj is not a BigInteger.");
    ...
    /// <param name="b">The 2nd BigInteger</param>
    /// <returns>True if a &gt;= b, false otherwise</returns>
    public static bool GreaterOrEqual(BigInteger a, BigInteger b) => BigInteger.Greater(a, b) || object.Equals((object) a, (object) b);
    ...
    public static BigInteger Abs(BigInteger n) => new BigInteger(n)
    {
      sign = Sign.Positive
    };
    ...
    /// <param name="b">The 2nd BigInteger</param>
    /// <returns>True if a == b, false otherwise</returns>
    public static bool operator ==(BigInteger a, BigInteger b) => object.Equals((object) a, (object) b);
    ...
    /// <param name="b">The 2nd BigInteger</param>
    /// <returns>The BigInteger result of the multiplication</returns>
    public static BigInteger operator *(BigInteger a, BigInteger b) => BigInteger.Multiplication(a, b);
