...
namespace ZXing.Aztec.Internal
{
  ...
  internal sealed class State
  {
    ...
    /// Binary Shift mode.
    /// </summary>
    public State endBinaryShift(int index) => this.binaryShiftByteCount == 0 ? this : new State(this.token.addBinaryShift(index - this.binaryShiftByteCount, this.binaryShiftByteCount), this.mode, 0, this.bitCount);
    ...
    public override string ToString() => string.Format("{0} bits={1} bytes={2}", (object) HighLevelEncoder.MODE_NAMES[this.mode], (object) this.bitCount, (object) this.binaryShiftByteCount);
  }
}
