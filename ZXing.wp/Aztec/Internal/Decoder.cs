...
namespace ZXing.Aztec.Internal
{
  ...
  public sealed class Decoder
  {
    ...
    public static string highLevelDecode(bool[] correctedBits) => Decoder.getEncodedData(correctedBits);
...
label_20:
    ...
    /// <returns></returns>
    private static Decoder.Table getTable(char t) => !Decoder.codeTableMap.ContainsKey(t) ? Decoder.codeTableMap['U'] : Decoder.codeTableMap[t];
