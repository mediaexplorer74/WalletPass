// ZXing.Rendering.WriteableBitmapRenderer
...
namespace ZXing.Rendering
{
  ...
  public class WriteableBitmapRenderer : IBarcodeRenderer<WriteableBitmap>
  {
    ...
    /// <returns></returns>
    public WriteableBitmap Render(BitMatrix matrix, BarcodeFormat format, string content) => this.Render(matrix, format, content, (EncodingOptions) null);
