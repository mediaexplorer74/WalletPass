...
namespace ZXing.PDF417.Internal
{
  ...
  public sealed class Codeword
  {
    ...
    public bool IsValidRowNumber(int rowNumber) => rowNumber != Codeword.BARCODE_ROW_UNKNOWN && this.Bucket == rowNumber % 3 * 3;

    /// <summary>Sets the row number as the row's indicator column.</summary>
    public void setRowNumberAsRowIndicatorColumn() => this.RowNumber = this.Value / 30 * 3 + this.Bucket / 3;
