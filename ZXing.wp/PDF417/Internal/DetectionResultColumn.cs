...
namespace ZXing.PDF417.Internal
{
  ...
  public class DetectionResultColumn
  {
    ...
    /// <param name="imageRow">Image row.</param>
    public Codeword getCodeword(int imageRow) => this.Codewords[this.imageRowToCodewordIndex(imageRow)];
    ...
    public void setCodeword(int imageRow, Codeword codeword) => this.Codewords[this.IndexForRow(imageRow)] = codeword;
