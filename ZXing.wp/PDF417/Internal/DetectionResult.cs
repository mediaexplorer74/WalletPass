...
namespace ZXing.PDF417.Internal
{
  ...
  public class DetectionResult
  {
    ...
    private void adjustIndicatorColumnRowNumbers(DetectionResultColumn detectionResultColumn) => ((DetectionResultRowIndicatorColumn) detectionResultColumn)?.adjustCompleteIndicatorColumnRowNumbers(this.Metadata);
