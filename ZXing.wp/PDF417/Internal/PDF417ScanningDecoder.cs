...
namespace ZXing.PDF417.Internal
{
  ...
  public static class PDF417ScanningDecoder
  {
    ...
    private static bool isValidBarcodeColumn(DetectionResult detectionResult, int barcodeColumn) => barcodeColumn >= 0 && barcodeColumn <= detectionResult.DetectionResultColumns.Length + 1;
    ...
    /// <param name="codeword">Codeword.</param>
    private static int getCodewordBucketNumber(int codeword) => PDF417ScanningDecoder.getCodewordBucketNumber(PDF417ScanningDecoder.getBitCountForCodeword(codeword));

    /// <summary>Gets the codeword bucket number.</summary>
    /// <returns>The codeword bucket number.</returns>
    /// <param name="moduleBitCount">Module bit count.</param>
    private static int getCodewordBucketNumber(int[] moduleBitCount) => (moduleBitCount[0] - moduleBitCount[2] + moduleBitCount[4] - moduleBitCount[6] + 9) % 9;
