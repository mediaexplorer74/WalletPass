...
namespace ZXing.PDF417
{
  ...
  public sealed class PDF417Reader : Reader, MultipleBarcodeReader
  {
    ...
    /// </summary>
    public Result decode(BinaryBitmap image) => this.decode(image, (IDictionary<DecodeHintType, object>) null);
    ...
    /// </summary>
    public Result[] decodeMultiple(BinaryBitmap image) => this.decodeMultiple(image, (IDictionary<DecodeHintType, object>) null);
    ...
    public Result[] decodeMultiple(BinaryBitmap image, IDictionary<DecodeHintType, object> hints) => PDF417Reader.decode(image, hints, true);
