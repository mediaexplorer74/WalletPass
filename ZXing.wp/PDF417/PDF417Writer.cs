...
namespace ZXing.PDF417
{
  ...
  public sealed class PDF417Writer : Writer
  {
    ...
    /// The generated barcode as a Matrix of unsigned bytes (0 == black, 255 == white)
    /// </returns>
    public BitMatrix encode(string contents, BarcodeFormat format, int width, int height) => this.encode(contents, format, width, height, (IDictionary<EncodeHintType, object>) null);
