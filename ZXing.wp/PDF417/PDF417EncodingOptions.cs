...
namespace ZXing.PDF417
{
  ...
  public class PDF417EncodingOptions : EncodingOptions
  {
    ...
    public bool Compact
    {
      get => this.Hints.ContainsKey(EncodeHintType.PDF417_COMPACT) && (bool) this.Hints[EncodeHintType.PDF417_COMPACT];
    ...
    {
      get => this.Hints.ContainsKey(EncodeHintType.PDF417_COMPACTION) ? (Compaction) this.Hints[EncodeHintType.PDF417_COMPACTION] : Compaction.AUTO;
    ...
    {
      get => this.Hints.ContainsKey(EncodeHintType.PDF417_DIMENSIONS) ? (Dimensions) this.Hints[EncodeHintType.PDF417_DIMENSIONS] : (Dimensions) null;
    ...
    {
      get => this.Hints.ContainsKey(EncodeHintType.CHARACTER_SET) ? (string) this.Hints[EncodeHintType.CHARACTER_SET] : (string) null;
      set
      {
        if (value == null)
        {
    ...
    {
      get => this.Hints.ContainsKey(EncodeHintType.DISABLE_ECI) && (bool) this.Hints[EncodeHintType.DISABLE_ECI];
