...
namespace ZXing
{
  public class BitmapLuminanceSource : BaseLuminanceSource
  {
    ...
    public BitmapLuminanceSource(WriteableBitmap writeableBitmap)
      : base(((BitmapSource) writeableBitmap).PixelWidth, ((BitmapSource) writeableBitmap).PixelHeight)
    {
      int pixelHeight = ((BitmapSource) writeableBitmap).PixelHeight;
      int pixelWidth = ((BitmapSource) writeableBitmap).PixelWidth;
      int[] pixels = default;//writeableBitmap.Pixels;
      int index1 = 0;
