...
namespace ZXing
{
  ...
  public class ResultPoint
  {
    ...
    /// </returns>
    public override bool Equals(object other) => other is ResultPoint resultPoint && (double) this.x == (double) resultPoint.x && (double) this.y == (double) resultPoint.y;

    /// <summary>Returns a hash code for this instance.</summary>
    /// <returns>
    /// A hash code for this instance, suitable for use in hashing algorithms and data structures like a hash table.
    /// </returns>
    public override int GetHashCode() => 31 * (((int) this.bytesX[0] << 24) + ((int) this.bytesX[1] << 16) + ((int) this.bytesX[2] << 8) + (int) this.bytesX[3]) + ((int) this.bytesY[0] << 24) + ((int) this.bytesY[1] << 16) + ((int) this.bytesY[2] << 8) + (int) this.bytesY[3];
