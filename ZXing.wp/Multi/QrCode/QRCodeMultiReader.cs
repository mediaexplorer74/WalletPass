...
namespace ZXing.Multi.QrCode
{
  ...
  public sealed class QRCodeMultiReader : QRCodeReader, MultipleBarcodeReader
  {
    ...
    private int SaSequenceSort(Result a, Result b) => (int) a.ResultMetadata[ResultMetadataType.STRUCTURED_APPEND_SEQUENCE] - (int) b.ResultMetadata[ResultMetadataType.STRUCTURED_APPEND_SEQUENCE];
  }
}
