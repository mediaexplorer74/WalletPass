...
namespace ZXing.OneD
{
  ...
  public sealed class UPCAReader : UPCEANReader
  {
    ...
    /// <returns></returns>
    public override Result decode(BinaryBitmap image, IDictionary<DecodeHintType, object> hints) => UPCAReader.maybeReturnResult(this.ean13Reader.decode(image, hints));
