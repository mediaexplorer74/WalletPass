...
namespace ZXing.OneD
{
  ...
  public sealed class UPCEReader : UPCEANReader
  {
    ...
    /// <returns></returns>
    protected override int[] decodeEnd(BitArray row, int endStart) => UPCEANReader.findGuardPattern(row, endStart, true, UPCEReader.MIDDLE_END_PATTERN);
    ...
    /// <param name="s"></param>
    /// <returns></returns>
    protected override bool checkChecksum(string s) => base.checkChecksum(UPCEReader.convertUPCEtoUPCA(s));
