...
namespace ZXing
{
    ...
    IMultipleBarcodeReader
  {
    ...
    public BarcodeReader(
      ...
      Func<WriteableBitmap, LuminanceSource> createLuminanceSource,
      Func<LuminanceSource, Binarizer> createBinarizer,
      Func<byte[], int, int, RGBLuminanceSource.BitmapFormat, 
          LuminanceSource> createRGBLuminanceSource)
      : base(reader, createLuminanceSource ??
            BarcodeReader.defaultCreateLuminanceSource, 
            createBinarizer, createRGBLuminanceSource)
    {
    }
  }
}
