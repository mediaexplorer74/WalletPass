...
namespace ZXing.Client.Result
{
  ...
  public abstract class ResultParser
  {
    ...
    private static readonly Regex DIGITS = new Regex("\\A(?:\\d+)\\z", (RegexOptions) 8);
    private static readonly Regex AMPERSAND = new Regex("&", (RegexOptions) 8);
    ...
    internal static bool isStringOfDigits(string value, int length) => value != null && length > 0 && length == value.Length && ResultParser.DIGITS.Match(value).Success;
