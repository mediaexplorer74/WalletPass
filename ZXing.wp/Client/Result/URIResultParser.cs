...
namespace ZXing.Client.Result
{
  ...
  {
    private static readonly Regex URL_WITH_PROTOCOL_PATTERN = new Regex("[a-zA-Z0-9]{2,}:", (RegexOptions) 8);
    private static readonly Regex URL_WITHOUT_PROTOCOL_PATTERN = new Regex("([a-zA-Z0-9\\-]+\\.)+[a-zA-Z]{2,}(:\\d{1,5})?(/|\\?|$)", (RegexOptions) 8);
