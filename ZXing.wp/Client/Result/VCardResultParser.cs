...
namespace ZXing.Client.Result
{
  ...
  {
    private static readonly Regex BEGIN_VCARD = new Regex("BEGIN:VCARD", (RegexOptions) 9);
    private static readonly Regex VCARD_LIKE_DATE = new Regex("\\A(?:\\d{4}-?\\d{2}-?\\d{2})\\z", (RegexOptions) 8);
    private static readonly Regex CR_LF_SPACE_TAB = new Regex("\r\n[ \t]", (RegexOptions) 8);
    private static readonly Regex NEWLINE_ESCAPE = new Regex("\\\\[nN]", (RegexOptions) 8);
    private static readonly Regex VCARD_ESCAPES = new Regex("\\\\([,;\\\\])", (RegexOptions) 8);
    private static readonly Regex EQUALS = new Regex("=", (RegexOptions) 8);
    private static readonly Regex SEMICOLON = new Regex(";", (RegexOptions) 8);
    private static readonly Regex UNESCAPED_SEMICOLONS = new Regex("(?<!\\\\);+", (RegexOptions) 8);
    private static readonly Regex COMMA = new Regex(",", (RegexOptions) 8);
    private static readonly Regex SEMICOLON_OR_COMMA = new Regex("[;,]", (RegexOptions) 8);
