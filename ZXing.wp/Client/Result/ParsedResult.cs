...
namespace ZXing.Client.Result
{
  ...
  public abstract class ParsedResult
  {
    ...
    public override bool Equals(object obj) => obj is ParsedResult parsedResult && parsedResult.Type.Equals((object) this.Type) && parsedResult.DisplayResult.Equals(this.DisplayResult);
