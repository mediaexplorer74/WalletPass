...
namespace ZXing.Common
{
  ...
  public class DecodingOptions
  {
    ...
    {
      get => this.Hints.ContainsKey(DecodeHintType.TRY_HARDER) 
                && (bool) this.Hints[DecodeHintType.TRY_HARDER];
      set
      {
        if (value)
        {
    ...
    {
      get => this.Hints.ContainsKey(DecodeHintType.PURE_BARCODE)
                && (bool) this.Hints[DecodeHintType.PURE_BARCODE];
      set
      {
        if (value)
        {
    ...
    {
      get => this.Hints.ContainsKey(DecodeHintType.CHARACTER_SET) 
                ? (string) this.Hints[DecodeHintType.CHARACTER_SET] 
                : (string) null;
      set
      {
        if (value != null)
    ...
    {
      get => this.Hints.ContainsKey(DecodeHintType.POSSIBLE_FORMATS)
                ? (IList<BarcodeFormat>) this.Hints[DecodeHintType.POSSIBLE_FORMATS] : (IList<BarcodeFormat>) null;
      set
      {
        if (value != null)
        {
    ...
    {
      get => this.Hints.ContainsKey(DecodeHintType.USE_CODE_39_EXTENDED_MODE)
                && (bool) this.Hints[DecodeHintType.USE_CODE_39_EXTENDED_MODE];
      set
      {
        if (value)
        {
    ...
    {
      get => this.Hints.ContainsKey(DecodeHintType.RELAXED_CODE_39_EXTENDED_MODE) && (bool) this.Hints[DecodeHintType.RELAXED_CODE_39_EXTENDED_MODE];
      set
      {
        if (value)
        {
    ...
    {
      get => this.Hints.ContainsKey(DecodeHintType.RETURN_CODABAR_START_END) && (bool) this.Hints[DecodeHintType.RETURN_CODABAR_START_END];
      set
      {
        if (value)
        {
      ...
      IEnumerable
    {
      ...
      public ChangeNotifyDictionary() => this.values = (IDictionary<TKey, TValue>) new Dictionary<TKey, TValue>();
      ...
      public void CopyTo(KeyValuePair<TKey, TValue>[] array, int arrayIndex) => this.values.CopyTo(array, arrayIndex);
