...
namespace ZXing.Common
{
  ...
  public sealed class CharacterSetECI : ECI
  {
    ...
    public static CharacterSetECI getCharacterSetECIByValue(int value) => value < 0 || value >= 900 ? (CharacterSetECI) null : CharacterSetECI.VALUE_TO_ECI[value];
    ...
    /// but unsupported
    /// </returns>
    public static CharacterSetECI getCharacterSetECIByName(string name) => CharacterSetECI.NAME_TO_ECI[name.ToUpper()];
  }
}
