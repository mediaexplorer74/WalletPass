...
namespace ZXing.Common
{
  ...
  public sealed class BitMatrix
  {
            ...
            get
            {
                return this.width == this.height
                    ...
                    : throw new ArgumentException(
                        "Can't call getDimension() on a non-square matrix");
            }
        }
    ...
    public void setRow(int y, BitArray row) => Array.Copy((Array) row.Array, 0, (Array) this.bits, y * this.rowSize, this.rowSize);
    ...
    public object Clone() => (object) new BitMatrix(this.width, this.height, this.rowSize, (int[]) this.bits.Clone());
