...
namespace ZXing.Common
{
  ...
  public class EncodingOptions
  {
    ...
    public int Height
    {
      get => this.Hints.ContainsKey(EncodeHintType.HEIGHT) ? (int) this.Hints[EncodeHintType.HEIGHT] : 0;
    ...
    public int Width
    {
      get => this.Hints.ContainsKey(EncodeHintType.WIDTH) ? (int) this.Hints[EncodeHintType.WIDTH] : 0;
    ...
    {
      get => this.Hints.ContainsKey(EncodeHintType.PURE_BARCODE) && (bool) this.Hints[EncodeHintType.PURE_BARCODE];
    ...
    public int Margin
    {
      get => this.Hints.ContainsKey(EncodeHintType.MARGIN) ? (int) this.Hints[EncodeHintType.MARGIN] : 0;
    ...
    /// </summary>
    public EncodingOptions() => this.Hints = (IDictionary<EncodeHintType, object>) new Dictionary<EncodeHintType, object>();
  }
}
