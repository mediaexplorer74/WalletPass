...
namespace ZXing.QrCode.Internal
{
  ...
  public sealed class Version
  {
    ...
    private static Version[] buildVersions() => new Version[40]
    {
      ...
      new Version(29, new int[6]{ 6, 30, 54, 78, 102, 126 }, new Version.ECBlocks[4]
      {
        new Version.ECBlocks(30, new Version.ECB[2]
        {
      ...
      new Version(30, new int[6]{ 6, 26, 52, 78, 104, 130 }, new Version.ECBlocks[4]
      {
        new Version.ECBlocks(30, new Version.ECB[2]
        {
      ...
      new Version(31, new int[6]{ 6, 30, 56, 82, 108, 134 }, new Version.ECBlocks[4]
      {
        new Version.ECBlocks(30, new Version.ECB[2]
        {
      ...
      new Version(32, new int[6]{ 6, 34, 60, 86, 112, 138 }, new Version.ECBlocks[4]
      {
        new Version.ECBlocks(30, new Version.ECB[1]
        {
      ...
      new Version(33, new int[6]{ 6, 30, 58, 86, 114, 142 }, new Version.ECBlocks[4]
      {
        new Version.ECBlocks(30, new Version.ECB[2]
        {
          new Version.ECB(17, 115),
      ...
      new Version(34, new int[6]{ 6, 34, 62, 90, 118, 146 }, new Version.ECBlocks[4]
      {
        new Version.ECBlocks(30, new Version.ECB[2]
        {
          new Version.ECB(13, 115),
