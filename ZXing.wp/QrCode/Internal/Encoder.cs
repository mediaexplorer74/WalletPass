...
namespace ZXing.QrCode.Internal
{
  ...
  public static class Encoder
  {
    ...
    public static QRCode encode(string content, ErrorCorrectionLevel ecLevel) => Encoder.encode(content, ecLevel, (IDictionary<EncodeHintType, object>) null);
    ...
    internal static int getAlphanumericCode(int code) => code < Encoder.ALPHANUMERIC_TABLE.Length ? Encoder.ALPHANUMERIC_TABLE[code] : -1;
