...
{
  public class tutorialMain : PhoneApplicationPage
  {
    internal Grid LayoutRoot;
    internal ImageBrush imgTap;
    private bool _contentLoaded;

    public tutorialMain()
    {
      this.InitializeComponent();
      this.imgTap.ImageSource = (ImageSource) new BitmapImage(new Uri("/Assets/Tutorial/Main/tapDown=" + CultureInfo.CurrentCulture.Name.Substring(0, 2) + ".jpg", UriKind.Relative));
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/Wallet%20Pass;component/Tutorials/tutorialMain.xaml", UriKind.Relative));
      this.LayoutRoot = (Grid) ((FrameworkElement) this).FindName("LayoutRoot");
      this.imgTap = (ImageBrush) ((FrameworkElement) this).FindName("imgTap");
    }
  }
}
