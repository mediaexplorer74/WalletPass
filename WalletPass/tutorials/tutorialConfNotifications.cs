...
// Type: WalletPass.tutorialConfNotifications
...
{
  public class tutorialConfNotifications : PhoneApplicationPage
  {
    internal Grid LayoutRoot;
    internal ImageBrush imgNotif;
    private bool _contentLoaded;

    public tutorialConfNotifications()
    {
      this.InitializeComponent();
      this.imgNotif.ImageSource = (ImageSource) new BitmapImage(new Uri("/Assets/Tutorial/Notifications/tutoNotif1=" + CultureInfo.CurrentCulture.Name.Substring(0, 2) + ".jpg", UriKind.Relative));
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/Wallet%20Pass;component/Tutorials/tutorialConfNotifications.xaml", UriKind.Relative));
      this.LayoutRoot = (Grid) ((FrameworkElement) this).FindName("LayoutRoot");
      this.imgNotif = (ImageBrush) ((FrameworkElement) this).FindName("imgNotif");
    }
  }
}
