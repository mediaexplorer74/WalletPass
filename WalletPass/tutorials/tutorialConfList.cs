...
// Type: WalletPass.tutorialConfList
...
{
  public class tutorialConfList : PhoneApplicationPage
  {
    internal Grid LayoutRoot;
    private bool _contentLoaded;

    public tutorialConfList()
    {
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/Wallet%20Pass;component/Tutorials/tutorialConfList.xaml", UriKind.Relative));
