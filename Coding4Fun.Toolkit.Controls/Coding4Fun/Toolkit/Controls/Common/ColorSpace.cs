...
namespace Coding4Fun.Toolkit.Controls.Common
{
  public class ColorSpace
  {
    ...
    public static LinearGradientBrush GetColorGradientBrush(Orientation orientation) => ColorSpace.CreateGradientBrush(orientation, ColorSpace.ColorGradients);

    public static LinearGradientBrush GetBlackAndWhiteGradientBrush(Orientation orientation) => ColorSpace.CreateGradientBrush(orientation, ColorSpace.BlackAndWhiteGradients);
    ...
    public static string GetHexCode(Color c) => string.Format("#{0}{1}{2}", (object) c.R.ToString("X2"), (object) c.G.ToString("X2"), (object) c.B.ToString("X2"));
