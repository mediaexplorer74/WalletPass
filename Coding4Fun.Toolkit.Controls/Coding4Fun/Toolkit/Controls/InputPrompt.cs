...
namespace Coding4Fun.Toolkit.Controls
{
  public class InputPrompt : UserPrompt
  {
    ...
    public bool IsSubmitOnEnterKey
    {
      ...
      set => ((DependencyObject) this).SetValue(InputPrompt.IsSubmitOnEnterKeyProperty, (object) value);
    }

    public TextWrapping MessageTextWrapping
    {
      get => (TextWrapping) ((DependencyObject) this).GetValue(InputPrompt.MessageTextWrappingProperty);
      set => ((DependencyObject) this).SetValue(InputPrompt.MessageTextWrappingProperty, (object) value);
    }
