...
namespace Coding4Fun.Toolkit.Controls
{
  public class SecondTimeSpanDataSource : TimeSpanDataSource
  {
    ...
    protected override TimeSpan? GetRelativeTo(TimeSpan relativeDate, int delta) => new TimeSpan?(new TimeSpan(relativeDate.Hours, relativeDate.Minutes, this.ComputeRelativeTo(relativeDate.Seconds, delta)));
  }
}
